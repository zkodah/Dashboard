...
var GeoFeature = class extends Element {
  ...
  updateExtras({ scale, feature: feature2, center, pixelRatio, mode: mode2 }) {
    var _a, _b;
    const changed = mode2 === "resize" || mode2 === "reset" || this.projectionScale !== scale || this.feature !== feature2 || ((_a = this.center) === null || _a === void 0 ? void 0 : _a.longitude) !== (center === null || center === void 0 ? void 0 : center.longitude) || ((_b = this.center) === null || _b === void 0 ? void 0 : _b.latitude) !== (center === null || center === void 0 ? void 0 : center.latitude) || this.pixelRatio !== pixelRatio;
...
var GeoController = class extends DatasetController {
  ...
  update(mode2) {
    ...
    const dirtyCache = scale.updateBounds() || mode2 === "resize" || mode2 === "reset";
    if (this.showOutline()) {
  ...
  updateElements(elems, start, count2, mode2) {
    ...
    for (let i = start; i < start + count2; i += 1) {
      ...
      const center = elem.updateExtras({
        scale,
        feature: this._data[i].feature,
        center: this._data[i].center,
